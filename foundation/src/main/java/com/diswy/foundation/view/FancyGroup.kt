 ...
 */
class FancyGroup @JvmOverloads constructor(
    context: Context,
    ...
    init {
        if (attrs != null) {
            ...
            mBorderColor =
                a.getInteger(R.styleable.FancyGroup_fg_border_color, Constants.DEFAULT_BORDER)
            mSolidNormal =
                a.getInteger(R.styleable.FancyGroup_fg_solid_normal, Constants.DEFAULT_TRANSPARENT)
            mSolidPressed =
                a.getInteger(R.styleable.FancyGroup_fg_solid_pressed, Constants.DEFAULT_PRESSED)
            mCornerRadius =
                a.getDimension(R.styleable.FancyGroup_fg_corner_radius, Constants.CORNER_RADIUS)
