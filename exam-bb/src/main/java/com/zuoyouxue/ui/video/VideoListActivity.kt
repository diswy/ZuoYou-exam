...
import com.zuoyouxue.databinding.ActivityVideoListBinding

class VideoListActivity : BaseToolbarBindActivity<ActivityVideoListBinding>(),
    ...
    override fun pageTitle(): String = "我的课程"
